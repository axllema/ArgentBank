...
function Features() {
    return (
        // Création d'une section pour les fonctionnalités
        <section className="features">
            <div className="feature-item">
                <img src={chatIcon} alt="chat icon" className="feature-icon" width="100" height="auto"/>
            ...
            <div className="feature-item">
                <img src={moneyIcon} alt="money icon" className="feature-icon" width="100" height="auto" />
                <h3 className="feature-item-title">More savings means higher rates</h3>
                <p>The more you save with us, the higher your interest rate will be!</p>
            </div>

            <div className="feature-item">
                <img src={securityIcon} alt="security icon" className="feature-icon" width="100" height="auto"/> 
